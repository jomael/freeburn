...
var
     ...
     Size : Integer;
begin
   CurrentDir.CreateLBAStart(True,CurrentLBA);
...
Procedure TImageTree.RecurseCount(CurrentDir : TDirectoryEntry);
var
     Index : Integer;
begin
   Inc(FTotalDirCount);
   Inc(FTotalFileCount,CurrentDir.GetFileCount);
   For Index := 0 to CurrentDir.GetDirCount -1 do
            RecurseCount(CurrentDir.GetDirEntry(Index));
end;


Procedure TImageTree.ResetAllCounts;
begin
   FTotalDirCount := 0;
   FTotalFileCount := 0;
   RecurseCount(RootDirectory);
end;
